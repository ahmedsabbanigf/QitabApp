	...
	<body>
		...
		<div id="show-livre" class="content scaffold-show" role="main">
			...
			<ol class="property-list livre">
				...
				<g:if test="${livreInstance?.nbrDisponibles}">
				<li class="fieldcontain">
					<span id="nbrDisponibles-label" class="property-label"><g:message code="livre.nbrDisponibles.label" default="Nbr Disponibles" /></span>
					
						<span class="property-value" aria-labelledby="nbrDisponibles-label"><g:fieldValue bean="${livreInstance}" field="nbrDisponibles"/></span>
